...
const GRASS_PRODUCTS = [
  {
    ...
    tag: 'Grass',
    basePrice: 69,
    description: '100% cotone <strong>premium</strong> Made in Italy. Regular Fit, stampa GRASS — ispirata alla superficie più veloce e imprevedibile del tennis. Verde scuro, il colore dell\'erba di Wimbledon.',
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
