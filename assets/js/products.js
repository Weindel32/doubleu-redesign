const WFOX_PRODUCTS = [
  ...
  },
  {
    ...
    basePrice: 59,
    description: {
      it: 'La tee limited edition della capsule WFOX. Costruzione premium, 100% cotone Made in Italy. Produzione limitata, zero riassortimento. Il pezzo che scompare prima di tutti gli altri.',
      en: 'The limited edition tee of the WFOX capsule. Premium construction, 100% cotton Made in Italy. Limited production, no restock. The piece that sells out first.',
      de: 'Das Limited-Edition-Shirt der WFOX Capsule. Premium-Verarbeitung, 100% Baumwolle Made in Italy. Limitierte Produktion, keine Nachbestellung. Das Teil, das zuerst vergriffen ist.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
  ...
  },
  {
    ...
    basePrice: 59,
    description: {
      it: 'Il pezzo iconico della capsule WFOX. Verde bosco profondo, grafica audace, messaggio diretto. Per chi sa esattamente dove mettere i piedi — e dove no.<br><br>100% cotone Made in Italy. Produzione limitata.',
      en: 'The signature piece of the WFOX capsule. Deep forest green, bold graphics, a message that needs no explaining. For those who know exactly where to step — and where not to.<br><br>100% cotton Made in Italy. Limited production.',
      de: 'Das Signature-Piece der WFOX Capsule. Tiefes Waldgrün, markante Grafik, eine klare Botschaft. Für alle, die genau wissen, wo sie hintreten — und wo nicht.<br><br>100% Baumwolle Made in Italy. Limitierte Produktion.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
  ...
  },
  {
    ...
    basePrice: 49,
    description: {
      it: 'La t-shirt essenziale della capsule WFOX. 100% cotone Made in Italy, con logo WFOX stampato sul petto. Semplice, diretta, riconoscibile. Il pezzo che non manca mai nel guardaroba di chi gioca sul serio.',
      en: 'The essential tee of the WFOX capsule. 100% cotton Made in Italy, with the WFOX logo printed on the chest. Simple, direct, recognisable. The piece that never leaves the wardrobe of anyone who plays for real.',
      de: 'Das essenzielle Shirt der WFOX Capsule. 100% Baumwolle Made in Italy, mit WFOX-Logo auf der Brust. Schlicht, direkt, unverkennbar. Das Teil, das im Schrank keines echten Spielers fehlt.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
    printSize: 'WFOX Logo',
...
const SURFACES_PRODUCTS = [
  {
    ...
    basePrice: 69,
    description: {
      it: '100% cotone <strong>premium</strong> Made in Italy. Regular Fit, stampa 100 CLAY — ispirata alla superficie più lenta, profonda ed elegante del tennis. Off White, colore che racconta la storia del gioco.',
      en: '100% <strong>premium</strong> cotton, Made in Italy. Regular fit, 100 CLAY print — inspired by the slowest, deepest and most elegant surface in tennis. Off White, a colour that carries the history of the game.',
      de: '100% <strong>Premium</strong>-Baumwolle, Made in Italy. Regular Fit, Print 100 CLAY — inspiriert vom langsamsten, tiefsten und elegantesten Belag des Tennis. Off White, eine Farbe, die die Geschichte des Spiels erzählt.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
  ...
  },
  {
    ...
    basePrice: 159,
    description: {
      it: 'Felpa in cotone premium Made in Italy. Il comfort del post-partita incontra l\'identità della superficie più tecnica del tennis. Produzione artigianale, tiratura limitata.',
      en: 'Premium cotton sweatshirt, Made in Italy. The comfort of the moments after the match meets the identity of the most demanding surface in tennis. Handcrafted production, limited run.',
      de: 'Sweatshirt aus Premium-Baumwolle, Made in Italy. Der Komfort nach dem Match trifft auf die Identität des anspruchsvollsten Belags im Tennis. Handwerkliche Fertigung, limitierte Auflage.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
  ...
  },
  {
    ...
    basePrice: 99,
    description: {
      it: 'Polo in Piqué di cotone premium Made in Italy. Il capo tecnico della capsule — on court e off court. Ricamo SURFACES sul petto, etichette interne artigianali.',
      en: 'Premium cotton piqué polo, Made in Italy. The technical piece of the capsule — on court and off court. SURFACES embroidery on the chest, handcrafted inner labels.',
      de: 'Poloshirt aus Premium-Baumwollpiqué, Made in Italy. Das technische Teil der Capsule — on court und off court. SURFACES-Stickerei auf der Brust, handgefertigte Innenetiketten.',
    },
    fit: 'Regular Fit',
  ...
  },
  {
    ...
    basePrice: 59,
    description: {
      it: 'Cappellino da tennis Made in Italy. Struttura a 6 pannelli, chiusura regolabile, ricamo CLAY sul fronte. Il complemento perfetto alla capsule SURFACES.',
      en: 'Tennis cap, Made in Italy. Six-panel construction, adjustable strap, CLAY embroidery on the front. The natural companion to the SURFACES capsule.',
      de: 'Tenniscap, Made in Italy. Sechs-Panel-Konstruktion, verstellbarer Verschluss, CLAY-Stickerei auf der Vorderseite. Die passende Ergänzung zur SURFACES Capsule.',
    },
    fit: 'Taglia Unica',
    material: '100% Cotone / Cotton',
...
const GRASS_PRODUCTS = [
  {
    ...
    basePrice: 69,
    description: {
      it: '100% cotone <strong>premium</strong> Made in Italy. Regular Fit, stampa GRASS — ispirata alla superficie più veloce e imprevedibile del tennis. Verde scuro, il colore dell\'erba di Wimbledon.',
      en: '100% <strong>premium</strong> cotton, Made in Italy. Regular fit, GRASS print — inspired by the fastest and most unpredictable surface in tennis. Dark green, the colour of the Wimbledon lawn.',
      de: '100% <strong>Premium</strong>-Baumwolle, Made in Italy. Regular Fit, Print GRASS — inspiriert vom schnellsten und unberechenbarsten Belag des Tennis. Dunkelgrün, die Farbe des Rasens von Wimbledon.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
    ...
    i18n: {
      ...
      de: {
        description: '100% Premium-Baumwolle Made in Italy. Regular Fit, GRASS-Druck — inspiriert von der schnellsten und unberechenbarsten Oberfläche im Tennis. Dunkelgrün, die Farbe des Wimbledon-Rasens.',
        fit: 'Regular Fit',
        material: '100% Baumwolle / Cotton',
  ...
  },
  {
    ...
    basePrice: 159,
    description: {
      it: 'Felpa in cotone premium Made in Italy. La stagione più breve del tennis, la più elegante. Patch ricamata GRASS sul petto. Produzione artigianale, tiratura limitata.',
      en: 'Premium cotton sweatshirt, Made in Italy. The shortest season in tennis, and the most elegant. Embroidered GRASS patch on the chest. Handcrafted production, limited run.',
      de: 'Sweatshirt aus Premium-Baumwolle, Made in Italy. Die kürzeste Saison im Tennis — und die eleganteste. Gestickter GRASS-Patch auf der Brust. Handwerkliche Fertigung, limitierte Auflage.',
    },
    fit: 'Regular Fit',
    material: '100% Cotone / Cotton',
